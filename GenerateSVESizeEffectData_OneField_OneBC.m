function [alpha, A, rsq, RVE_edge, RVE_vol, lV, lVar2, lVar2_fit, nExisting, nRequired, middle_low_high] = ...
GenerateSVESizeEffectData_OneField_OneBC(nameWOExt, epsilon, use_cov_over_std, use_minMax_over_meanpmstd, dim, logbase)
if nargin < 1
...
SStotal = (length(lVar2)-1) * var(lVar2);
